...
<body>
    ...
    <main>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
                        <div class="single-card text-center mb-30">
                            <div class="card-top">
                                <img src="{{asset('assets/img/gallery/price1.png')}}" alt="">
        ...
        <!-- Pricing Card End -->
        <section class="load-balancing  pt-top section-bg2" data-background="{{asset('assets/img/gallery/section_bg01.png')}}">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-features mb-40">
                            <div class="features-icon">
                                <img src="{{asset('assets/img/gallery/right-icon.png')}}" alt="">
                            </div>
        ...
        <!--? About 1 Start-->
        <!-- Support Area Start -->
        <section class="support-area section-bg2 pt-130 pb-130" data-background="{{asset('assets/img/gallery/section_bg02.png')}}">
            <div class="container">
        ...
        <!-- End Map -->
         <!--? Testimonial Start -->
        <div class="testimonial-area testimonial-padding section-bg2" data-background="{{asset('assets/img/gallery/section_bg04.png')}}">
        <div class="container">
        ...
        <div class="brand-area">
            <div class="container">
                <div class="brand-active brand-border pt-50 pb-40">
                    ...
                    <div class="single-brand">
                        <img src="{{asset('assets/img/gallery/brand6.png')}}" alt="">
                    </div>
                    <div class="single-brand">
                        <img src="{{asset('assets/img/gallery/brand4.png')}}" alt="">
                    </div>
        ...
        <!-- Testimonial End -->
        <!-- ask questions -->
        <section class="ask-questions section-bg2 section-padding30" data-background="{{asset('assets/img/gallery/section_bg03.png')}}">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-11 col-lg-11 col-md-10 ">
                        <!-- Section Tittle -->
    ...
    <footer>
        <div class="footer-wrappr  section-bg" data-background="{{asset('assets/img/gallery/footer_bg.png')}}">
